<div x-data="{ counter: 0 }">
    ...
    <div class="row mb-3 g-3 align-items-end">
        ...
        <div class="col-md-3">
            ...
            <select id="nameDriver" wire:model.live="selected_driver" class="form-select shadow-sm">
                <option value="">اختر السائق</option>
                @foreach ($drivers as $driver)
                    <option value="{{ $driver->nameDriver }}">
                        {{ $driver->nameDriver }}
                    </option>
                @endforeach
            </select>
                ...
                <div
                    ...
                    <div
                        ...
                        <button class="btn btn-outline-primary" wire:click="printdriver"
                            @if (!$selected_driver) disabled @endif>
                            <div class="d-flex align-items-center justify-content-center">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width: 220px;">
            <!-- Print -->
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" wire:click="print({{ $invoice->id }})">
            ...
            <!-- Mark as Paid -->
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" wire:click="payment({{ $invoice->id }})">
                    <div class="icon-container bg-success bg-opacity-10 p-2 rounded me-2">
