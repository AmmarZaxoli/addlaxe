                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="todaySalesValue">IQD {{ $todaySales }}</div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="todayProfitValue">IQD {{ $todayProfit }}</div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="totalDeptValue">IQD {{ $totalDept }}</div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="todayDeliveryValue">{{ $todayDelivery }}</div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="todayOrdersValue">{{ $todayOrders }}</div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="metric-value" id="pendingDeliveryValue">{{ $pendingDelivery }}</div>
                            </div>
