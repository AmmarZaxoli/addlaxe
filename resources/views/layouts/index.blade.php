...
<body>
    ...
    <!-- Topbar -->
    <nav class="topbar">
        <button class="btn btn-link text-dark d-lg-none" type="button" id="sidebarTogglePremium">
            <i class="bi bi-list fs-3"></i>
        </button>
    </nav>

    <!-- Sidebar Backdrop -->
    <div class="sidebar-backdrop" id="sidebarBackdropPremium"></div>

    <!-- Premium White Sidebar -->
    <aside class="sidebar-premium" id="sidebarPremium">
        <!-- Sidebar Brand -->
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-group">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#driversMenuPremium" role="button"
                            aria-expanded="false">
                            <span class="nav-icon"><i class="bi bi-people"></i></span>
                            <span class="nav-text">إدارة السوائق</span>
                            <span class="nav-arrow"><i class="bi bi-chevron-left"></i></span>
                        </a>
                        <div class="collapse" id="driversMenuPremium">
                            <ul class="submenu">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <span class="nav-text">قائمة السوائق</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <span class="nav-text">صلاحيات السوائق</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <a class="nav-link {{ Route::is('accounts.create', 'accounts.*') ? 'active' : '' }}"
                        ...
                        <span class="nav-icon"><i class="bi bi-cart-plus"></i></span>
                        <span class="nav-text">حسابات</span>
                    </a>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#productsMenuPremium" role="button"
                            aria-expanded="false">
                            <span class="nav-icon"><i class="bi bi-box-seam"></i></span>
                            <span class="nav-text">إدارة المنتجات</span>
                            <span class="nav-arrow"><i class="bi bi-chevron-left"></i></span>
                        </a>
                        <div class="collapse" id="productsMenuPremium">
                            <ul class="submenu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <span class="nav-text">إضافة منتج Excel</span>
                                    </a>
                                </li>
            ...
            <div class="nav-group">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#settingsMenuPremium" role="button"
                            aria-expanded="false">
                            <span class="nav-icon"><i class="bi bi-gear"></i></span>
                            <span class="nav-text">الإعدادات</span>
                            <span class="nav-arrow"><i class="bi bi-chevron-left"></i></span>
                        </a>
                        <div class="collapse" id="settingsMenuPremium">
                            <ul class="submenu">
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <span class="nav-text">إعدادات الدفع</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <span class="nav-text">إعدادات البريد</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('dashboards.create') ? 'active' : '' }}"
                            ...
                            <span class="nav-icon"><i class="bi bi-speedometer2"></i></span> <span class="nav-text">لوحة
                                التحكم</span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('driver.create', 'driver.*') ? '' : 'collapsed' }}"
                            data-bs-toggle="collapse" href="#driversMenuPremium" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('types.create', 'products.create', 'definitions.create') ? '' : 'collapsed' }}"
                            data-bs-toggle="collapse" href="#productsMenuPremium" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('offers.create') ? '' : 'collapsed' }}"
                            ...
                            <span class="nav-text">إدارة اوفرات</span>
                            <span class="nav-arrow"><i class="bi bi-chevron-left"></i></span>
                        </a>
                            ...
                            <ul class="submenu">
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('offers.create') ? 'active' : '' }}"
                                        ...
                                        <span class="nav-text">إنشاء أوفر</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('offers.edit') ? 'active' : '' }}"
                                        href="{{ route('offers.edit') }}">
                                        <span class="nav-text">تعديل أوفر</span>
                                    </a>
                                </li>
