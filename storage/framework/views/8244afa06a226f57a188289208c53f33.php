                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="nameDriver" name="nameDriver" wire:model.live="selected_driver"
                                class="form-select">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary"
                                                wire:click="addProduct(<?php echo e($product->id); ?>)">Add
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="removeProduct(<?php echo e($product['id']); ?>)"
                                                class="btn btn-sm btn-danger">إزالة</button>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
...
<?php /**PATH C:\Users\PC\Desktop\forhost\resources\views/livewire/selling/sell.blade.php ENDPATH**/ ?>