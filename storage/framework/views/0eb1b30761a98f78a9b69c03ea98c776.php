...
$__html = app('livewire')->mount($__name, $__params, 'lw-1879778135-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1879778135-1', $__slots ?? [], get_defined_vars());
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="row mb-3 g-3 align-items-end">
        ...
        <div class="col-md-3">
            ...
            <select id="nameDriver" wire:model.live="selected_driver" class="form-select shadow-sm">
                <option value="">اختر السائق</option>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($driver->nameDriver); ?>">
            ...
            <div class="card-body p-0">
                <div
                    ...
                    <div
                        ...
                        <button class="btn btn-outline-primary" wire:click="printdriver"
                            <?php if(!$selected_driver): ?> disabled <?php endif; ?>>
                            <div class="d-flex align-items-center justify-content-center">
                                <i class="fas fa-print me-2"></i>
                                <span>طباعة تقرير السائق</span>
                            </div>
                        </button>
                    </div>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width: 220px;">
            <!-- Print -->
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" wire:click="print(<?php echo e($invoice->id); ?>)">
                    <div class="icon-container bg-primary bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-print text-primary fs-6"></i>
                    </div>
                    <span class="fw-medium">طباعة</span>
                </button>
            </li>
            ...
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" 
                    ...
                    <div class="icon-container bg-success bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-cart-plus text-success fs-6"></i>
                    </div>
                    <span class="fw-medium">إضافة منتجات</span>
                </button>
            </li>
            
            <!-- Mark as Paid -->
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" wire:click="payment(<?php echo e($invoice->id); ?>)">
                    <div class="icon-container bg-success bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-check-circle text-success fs-6"></i>
                    </div>
                    <span class="fw-medium">تم الدفع</span>
                </button>
            </li>
            ...
            <li>
                <button class="dropdown-item d-flex align-items-center py-2" 
                        ...
                        wire:click="numinvoice(<?php echo e($invoice->num_invoice_sell); ?>)">
                    <div class="icon-container bg-warning bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-edit text-warning fs-6"></i>
                    </div>
                    <span class="fw-medium">تعديل الفاتورة</span>
                </button>
            </li>
            ...
            <li>
                <button class="dropdown-item d-flex align-items-center py-2"
                    ...
                    <div class="icon-container bg-info bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-user-edit text-info fs-6"></i>
                    </div>
                    <span class="fw-medium">تعديل السائق</span>
                </button>
            </li>
            ...
            <li>
                <button class="dropdown-item d-flex align-items-center py-2 text-danger"
                    ...
                    <div class="icon-container bg-danger bg-opacity-10 p-2 rounded me-2">
                        <i class="fas fa-trash-alt text-danger fs-6"></i>
                    </div>
                    <span class="fw-medium">حذف الفاتورة</span>
                </button>
            </li>
        </ul>
    </div>
...
<?php /**PATH C:\Users\Malta Computer\Desktop\forhost\resources\views/livewire/drivers/invoice-controls/show.blade.php ENDPATH**/ ?>